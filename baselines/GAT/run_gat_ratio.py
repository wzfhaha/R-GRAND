...
class EntityClassify(BaseGAT):
    ...
    def build_hidden_layer(self, idx):
        ...
        return GATConv(self.h_dim * self.num_heads, self.h_dim, self.num_heads, feat_drop=self.dropout, activation=F.relu)

    def build_output_layer(self):
        return GATConv(self.h_dim * self.num_heads, self.out_dim, self.num_heads, feat_drop=self.dropout)
        """
        if self.simplify:
