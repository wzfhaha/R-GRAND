...
lr = 0.005
weight_decay = 0.001
etypes_list = [[2, 5], [3, 6], [0, 2, 5], [0, 3, 6], [1, 2, 5], [1, 3, 6]]
...
def run_model_DBLP(feats_type, hidden_dim, num_heads, attn_vec_dim, rnn_type,
    ...
    adjlists, edge_metapath_indices_list, features_list, adjM, type_mask, labels, train_val_test_idx, dl = load_ACM_data(args)
...
if __name__ == '__main__':
    ...
    ap.add_argument('--hidden-dim', type=int, default=32, help='Dimension of the node hidden state. Default is 64.')
