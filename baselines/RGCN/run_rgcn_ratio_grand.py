...
from model import RelGraphConv_s, RelGraphConv
import dgl
    ...
    def build_hidden_layer(self, idx):
        if self.simplify:
            ...
            return RelGraphConv(self.h_dim, self.h_dim, self.num_rels, activation=F.elu, 
                            ...
                            dropout=self.dropout, layer_norm=self.layer_norm, mcdropedge=args.mcdropedge)
        else:
    ...
    def build_output_layer(self):
        if self.simplify:
            ...
            return RelGraphConv(self.h_dim, self.out_dim, self.num_rels, activation=None, 
                                self_loop=self.use_self_loop, layer_norm=False, mcdropedge=args.mcdropedge)
        else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_ratio', type=float, default=0.01, help='train num')
    ...
    if args.search:
        search_space = {'hidden_dim':[32, 64, 128], 'num_layers':[2, 3], 'dropout': [0.3, 0.5, 0.7]}
