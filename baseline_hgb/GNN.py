...
class RGRAND(nn.Module):
    def __init__(self,
        ...
        self.gat_layers.append(SRGC(num_etypes,
                ...
                feat_drop, mcdropedge, negative_slope, self.activation, bias=False, pre_alpha=pre_alpha, fix_edge=fix_edge, wo_norm=wo_norm, aug=aug))
        ...
        self.predict_layer_attn = SRGC(num_etypes,
            ...
            feat_drop, mcdropedge, negative_slope, None, bias=False, pre_alpha=pre_alpha, fix_edge=fix_edge, wo_norm=wo_norm, aug=aug)
